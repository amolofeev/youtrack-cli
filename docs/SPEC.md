...
- Go-модуль: `github.com/amolofeev/prompt-and-pray` (репозиторий уже существует; код утилиты
  живёт в подкаталоге `cmd/yt` и пакетах `internal/...` в этом же репозитории).
